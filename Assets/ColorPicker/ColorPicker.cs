...
public class ColorPicker : MonoBehaviour {
	...
	void OnGUI()
	{
		startPos.x = canvas.transform.position.x - 150;
		startPos.y = canvas.transform.position.y - 250;
	...
	public void _DrawGUI () 
	{
		...
		GUI.Label(new Rect(startPos.x + sizeCurr + 120, startPos.y, 200, 30), Title, titleStyle);

		GUI.DrawTexture(new Rect(startPos.x + sizeCurr + 10, startPos.y, 100, 20), txColorDisplay);
