...
namespace HexagonPuzzle.Editors
{
    ...
    public class PieceEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < SharedPropertiesHelper.SharedProperties.GridColors.Count; i++)
                {
                    ...
                    {
                        piece.Color = SharedPropertiesHelper.SharedProperties.GridColors[i];
        ...
        private void OnEnable()
        {
            ...
            ColoredButtons = new Texture2D[SharedPropertiesHelper.SharedProperties.GridColors.Count];
            for(int i = 0; i < ColoredButtons.Length; i++)
            {
                ...
                for (int y = 0; y < colors.Length; y++)
                    colors[y] = SharedPropertiesHelper.SharedProperties.GridColors[i];
